...
export const getRouterData = (app) => {
  const routerConfig = {
    ...
    '/pos': {
      component: dynamicWrapper(app, ['commodity', 'express'], () => import('../layouts/PosLayout')),
    },
    '/express': {
    ...
    '/dailyClosing/cashStatistics': {
      component: dynamicWrapper(app, ['dailyClosing'], () => import('../routes/DailyClosing/CashStatistics')),
    },
  ...
  Object.keys(routerConfig).forEach((path) => {
    ...
    router = {
      ...
      authority: router.authority || menuItem.authority || 'guest',
    };
